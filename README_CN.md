...
- 接管歌词播放页的整屏视觉层，提供四套安全预设与桌面自定义布局，并针对平板、手机和矮屏横屏使用独立响应式安全区
- 整合歌曲/歌手/专辑/封面、进度、音量、静音、停止、上一首、播放暂停、下一首、随机、循环、队列、注音和封面旋转开关
- 背景高斯模糊与压暗、唱片尺寸/位置、歌曲信息位置、歌词区域位置/宽度/行距/弱化透明度均可独立调整
...
设置抽屉按七组独立组织：背景可选黑色、白色或专辑封面高斯模糊，并可调整模糊与压暗强度；界面提供歌词居左、歌词居中、大唱片、上下布局和自定义布局；自定义构图可分别调整唱片尺寸/位置、歌曲信息位置和歌词区域位置/宽度；频谱形态可选标准频谱、峰值回落、曲线、折线或小球；频谱色彩可选纯色、双色渐变、多色渐变或彩虹渐变；歌词可独立调整主题、对齐、70%–170% 字号、行距与非当前行透明度；播放细节提供注音/翻译和封面旋转开关。切换某一组不会暗中改变其他组。
